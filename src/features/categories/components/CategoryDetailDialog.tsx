/**
 * Dialogo modal que muestra el detalle completo de una categoría
...
import { useAdminCategoryDetail } from "@/features/categories/hooks";
...
export function CategoryDetailDialog({
  ...
  const {
    ...
    isLoading,
    isError,
  } = useAdminCategoryDetail(categoryId, open);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="bg-primary text-primary-foreground px-4 sm:px-10 py-4 rounded-t-lg flex items-center justify-between">
          <DialogTitle className="text-lg">Detalle de la Categoría</DialogTitle>
          <DialogClose asChild>
            <Button
              variant="ghost"
              size="icon-sm"
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center gap-8 text-center">
              ...
              <table
                ...
                aria-label="Metadatos de la categoría"
              >
                <tbody>
                  {[
                    {
