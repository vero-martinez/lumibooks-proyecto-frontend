/**
 * Barra de filtros para la tabla de gestión de pedidos (panel gestor).
 * Buscador + filtros de estado, ordenamiento y rango de fechas (shadcn Calendar).
 */
"use client";
...
import {
  ...
  MANAGER_ORDER_SORT_OPTIONS,
  MANAGER_ORDERS,
} from "@/features/orders/constants";
import type { ManagerOrderFilters, OrderStatus } from "@/features/orders/types";

interface ManagerOrderFiltersBarProps {
  filters: ManagerOrderFilters;
  updateFilters: (filters: ManagerOrderFilters) => void;
  onClear: () => void;
}
...
export function ManagerOrderFiltersBar({
  filters,
  updateFilters,
  onClear,
}: ManagerOrderFiltersBarProps) {
  ...
  const dateLabel =
    dateRange.from && dateRange.to
      ...
      : dateRange.from
        ...
        : (MANAGER_ORDERS.dateRangeLabel ?? "Rango de fechas");
    ...
    <div className="flex flex-col gap-3">
      <div className="w-full lg:w-1/2">
        <SearchBar
          ...
          placeholder={MANAGER_ORDERS.searchPlaceholder}
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <SortSelect
          ...
          placeholder={MANAGER_ORDERS.sortLabel}
          ariaLabel={MANAGER_ORDERS.sortLabel}
          className={SELECT_CLASS}
          options={[...MANAGER_ORDER_SORT_OPTIONS]}
          allowNone={false}
        />
